      ...
      <nav className="flex justify-between text-white items-center w-full">
        <div className="">
          <img
            src="/images/logo.png"
            alt="Hub's Logo"
            className="md:h-16 md:w-full h-12 w-12 cursor-pointer"
          />
        </div>
        <NavMenu />

        <ul className="hidden md:flex w-1/3 justify-between font-semibold text-lg cursor-pointer items-center">
